    ...
    if(interaction.isButton()) {
        ...
        if (interaction.customId === 'eck1') { 
         ...
         await interaction.member.roles.add(info.katılım.roleçekilkatılım);
          interaction.reply({ content: `Üzerinize <@&${info.katılım.roleçekilkatılım}> rolü verildi.`, ephemeral: 'true' } )
          } else {
            
          interaction.member.roles.remove(info.katılım.roleçekilkatılım)
            interaction.reply({ content: `Üzerinizden <@&${info.katılım.roleçekilkatılım}> rolü alındı.`, ephemeral: 'true' } )
          }
        }
        if (interaction.customId === 'eck2') {
            ...
            if (!erolesvar) {
                await interaction.member.roles.add(info.katılım.roleetkinkatılım);
                 interaction.reply({ content: `Üzerinize <@&${info.katılım.roleetkinkatılım}> rolü verildi.`, ephemeral: 'true' } )
            } else {
                await interaction.member.roles.remove(info.katılım.roleetkinkatılım);
                 interaction.reply({ content: `Üzerinizden <@&${info.katılım.roleetkinkatılım}> rolü alındı.`, ephemeral: 'true' } )
            }
   ...
   interaction.reply({ content: `Başarıyla <@&${info.kayıtsız}> rolünü verdim ve ismini \`${info.tag} İsim | Yaş\` olarak ayarladım <#${info.registerchat}> kanalına yazabilirsin ^^`, ephemeral: true })
    ...
    if (interaction.isStringSelectMenu()) {
        ...
        if (seçim === 'takım1') {
          ...
          if(!frol) { 
            ...
            await interaction.member.roles.add(info.takım.fener);
             interaction.reply({ content: `Üzerinize <@&${info.takım.fener}> rolünü ekledim`, ephemeral: true })
        } else {
            interaction.reply({ content: `<@&${info.takım.fener}> rolüne zaten sahipsiniz.`, ephemeral: true })
        }}
        ...
        if (seçim === 'takım2') {
            let grol = await interaction.member.roles.cache.get(info.takım.galat)
              ...
              if(!grol) { 
                ...
                await interaction.reply({ content: `Üzerinize <@&${info.takım.galat}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.takım.galat}> rolüne zaten sahipsiniz.`, ephemeral: true })
            }
        }
        ...
        if (seçim === 'takım3') {
            let brol = await interaction.member.roles.cache.get(info.takım.besik)
              ...
              if(!brol) { 
                ...
                await interaction.reply({ content: `Üzerinize <@&${info.takım.besik}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.takım.besik}> rolüne zaten sahipsiniz.`, ephemeral: true })
            }
        }
        ...
        if (seçim === 'takım4') {
            let trol = await interaction.member.roles.cache.get(info.takım.trabzon)
              ...
              if(!trol) {
                ...
                await interaction.reply({ content: `Üzerinize <@&${info.takım.trabzon}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.takım.trabzon}> rolüne zaten sahipsiniz.`, ephemeral: true })
            }
        }
        ...
        if (seçim === 'takım5') {
            let mbrol = await interaction.member.roles.cache.get(info.takım.basak)
              ...
              if(!mbrol) { 
                ...
                await interaction.reply({ content: `Üzerinize <@&${info.takım.basak}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.takım.basak}> rolüne zaten sahipsiniz.`, ephemeral: true })
            }
        }
        ...
        if (seçim === 'takım6') {
            ...
            await interaction.member.roles.remove(takımroller);
            await interaction.reply({ content: `Sevgili **__${interaction.guild.name}__** üyesi, üzerinizden **Takım** rolleriniz sıfırlandı`, ephemeral: true })
        }
        ...
        if (seçim === 'i1') {
            ...
            await interaction.member.roles.add(info.ilişki.couple)
             interaction.reply({ content: `Üzerinize <@&${info.ilişki.couple}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.ilişki.couple}> rolüne zaten sahipsiniz.`, ephemeral: true }) 
            }
        }
        ...
        if (seçim === 'i2') {
            ...
            await interaction.member.roles.add(info.ilişki.alone)
             interaction.reply({ content: `Üzerinize <@&${info.ilişki.alone}> rolünü ekledim`, ephemeral: true })
            } else {
                await interaction.reply({ content: `<@&${info.ilişki.alone}> rolüne zaten sahipsiniz.`, ephemeral: true }) 
            }
        }
        if (seçim === 'i3') {
            await interaction.member.roles.remove(info.ilişki.couple)
            await interaction.member.roles.remove(info.ilişki.alone)
             interaction.reply({ content: `Sevgili **__${interaction.guild.name}__** üyesi, üzerinizden **İlişki** rolleriniz sıfırlandı`, ephemeral: true })
        }
        ...
        if (seçim === 'oyun1') {
           ...
           if(!frol) { 
             ...
             await interaction.member.roles.add(info.oyun.mlbb);
              interaction.reply({ content: `Üzerinize <@&${info.oyun.mlbb}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.mlbb}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'oyun2') {
           ...
           if(!frol) { 
             ...
             await interaction.member.roles.add(info.oyun.csgo);
              interaction.reply({ content: `Üzerinize <@&${info.oyun.csgo}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.csgo}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'oyun3') {
           ...
           if(!frol) { 
             ...
             await interaction.reply({ content: `Üzerinize <@&${info.oyun.pubg}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.pubg}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'oyun4') {
           ...
           if(!frol) { 
             ...
             await interaction.member.roles.add(info.oyun.lol);
              interaction.reply({ content: `Üzerinize <@&${info.oyun.lol}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.lol}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'oyun5') {
           ...
           if(!frol) { 
             ...
             await interaction.member.roles.add(info.oyun.valorant);
              interaction.reply({ content: `Üzerinize <@&${info.oyun.valorant}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.valorant}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'oyun6') {
           ...
           if(!frol) { 
             ...
             interaction.reply({ content: `Üzerinize <@&${info.oyun.gtav}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.gtav}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}


         if (seçim === 'oyun7') {
            let frol = await interaction.member.roles.cache.get(info.oyun.minecraft)
             
           if(!frol) { 
           
             await interaction.member.roles.add(info.oyun.minecraft);
             interaction.reply({ content: `Üzerinize <@&${info.oyun.minecraft}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.oyun.minecraft}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'renk1') {
            ...
            if(!member.roles.cache.has(info.taglı) && !member.roles.cache.has(info.booster)) {
                interaction.reply({ content: `Sevgili **__${interaction.guild.name}__** üyesi, **renk** rolleri sadece __family & booster__ üyelerimiz içindir`, ephemeral: true })
           return
            }
           ...
           if(!frol) { 
             ...
             interaction.reply({ content: `Üzerinize <@&${info.renk.kırmızı}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.renk.kırmızı}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}

    
         if (seçim === 'renk2') {
            let frol = await interaction.member.roles.cache.get(info.renk.turuncu)
           ...
           if(!frol) { 
             ...
             interaction.reply({ content: `Üzerinize <@&${info.renk.beyaz}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.renk.beyaz}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'renk3') {
           ...
           return
             ...
             interaction.reply({ content: `Üzerinize <@&${info.renk.mavi}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.renk.mavi}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'renk4') {
           ...
           return
             ...
             interaction.reply({ content: `Üzerinize <@&${info.renk.sarı}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.renk.sarı}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'renk5') {
           ...
           return
             ...
             interaction.reply({ content: `Üzerinize <@&${info.renk.yeşil}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.renk.yeşil}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b1') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.akrep}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.akrep}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b2') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.boğa}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.boğa}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b3') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.başak}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.başak}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b4') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.ikizler}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.ikizler}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b5') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.kova}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.kova}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b6') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.koç}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.koç}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b7') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.yengeç}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.yengeç}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b8') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.oğlak}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.oğlak}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b9') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.terazi}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.terazi}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b10') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.aslan}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.aslan}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b11') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.balık}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.balık}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
         ...
         if (seçim === 'b12') {
           ...
           if(!frol) { 
            await interaction.member.roles.remove(burçroller)
             ...
             interaction.reply({ content: `Üzerinize <@&${info.burç.yay}> rolünü ekledim`, ephemeral: true })
         } else {
             interaction.reply({ content: `<@&${info.burç.yay}> rolüne zaten sahipsiniz.`, ephemeral: true })
         }}
...
client.login(process.env.roletoken)
